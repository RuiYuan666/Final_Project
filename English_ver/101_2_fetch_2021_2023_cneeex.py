...
Output: Single merged CSV (CNEEEX_National_Carbon_Data_2021_2023.csv)
"""
...
def main():
    YEAR_CONFIG = {
        '2021': ('全国碳市场2021年度交易数据_合并.csv', None),
        '2022': ('全国碳市场2022年度交易数据_合并.csv', '2022-12-31'),
        '2023': ('全国碳市场2023年度交易数据_合并.csv', '2023-08-25'),
    }

    MERGED_CSV = os.path.join(OUTPUT_DIR, 'CNEEEX_National_Carbon_Data_2021_2023.csv')
    ...
    unique_dates = set(r[0] for r in all_records)
    print(f"\n{'='*60}")
    print(f"Done! {len(all_records)} records, {len(unique_dates)} trading days")
