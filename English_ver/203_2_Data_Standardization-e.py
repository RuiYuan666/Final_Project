...
# ===================== 【关键修改】删除无效行：最高价 或 最低价 = 0 的记录 =====================
df = df[(df["highest_price_cny_ton"] != 0) & (df["lowest_price_cny_ton"] != 0)].copy()
...
# ===================== 5. Save Result =====================
df.to_csv("CRC_price_e_processed_fix.csv", index=False, encoding="utf-8-sig")

# ===================== Output Preview =====================
print("✅ Data processing completed!")
print("📌 Removed rows where highest OR lowest price = 0")
